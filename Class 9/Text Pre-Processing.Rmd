...
DFM_Rubio <- dfm_remove(DFM_Rubio, pattern = c("one", "also", "Rubio", "president", "amp", "@mike_Rubio"))
...
DFM_Master <- dfm_remove(DFM_Master, pattern = c("one", "also", "president", "amp", "obama", "@mike_Rubio"))
