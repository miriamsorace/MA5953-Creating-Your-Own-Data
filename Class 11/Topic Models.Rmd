...
MasterTweets <- rbind(ObamaTweets, PenceTweets)
...
plot.estimateEffect(author_effect, "author", method = "difference", 
                    cov.value1 = "Mike_Pence", cov.value2 = "BarackObama",
                    verbose.labels=F,
                    title("Mean Difference in Topic Proportions (Pence-Obama)"),
                    xlab="Left: Obama; Right: Pence")
