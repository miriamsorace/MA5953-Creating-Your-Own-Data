...
1. Go to the website for the European Centre for Disease Prevention and Control: https://www.ecdc.europa.eu/en/cases-2019-ncov-eueea
2. Play around with the webpage: what does it contain?
3. Scrape the main table in the webpage, input your code below (tip: Task 3 provides the answer):
